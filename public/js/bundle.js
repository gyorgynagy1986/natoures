...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false //center: [17.5969, 8.0829],
    //zoom: 4
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'logged in sucesfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
exports.updateTour = exports.updateSettings = exports.removeTour = exports.addTour = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " is sucesfully updated"));
            }
...
var addTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, difficulty, startDates, summary) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            console.log(res);
            (0, _alert.showAlert)('success', 'The Tour is sucesfully ADDED');
            window.setTimeout(function () {
  ...
  return function addTour(_x3, _x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
var updateTour = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, difficulty, startDates, summary, e) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/tours/".concat(e),
              data: {
                name: name,
                difficulty: difficulty,
                startDates: startDates,
  ...
  return function updateTour(_x7, _x8, _x9, _x10, _x11) {
    return _ref3.apply(this, arguments);
  };
}(); // UPDATE A TOUR
// REMOVE TOUR
...
var removeTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:3000/api/v1/tours/".concat(id)
            });

          case 3:
            res = _context4.sent;
            console.log(res);
            (0, _alert.showAlert)('success', 'The Tour is sucesfully REMOVED');
            window.setTimeout(function () {
              location.assign('/all-tours');
            }, 1500);
            _context4.next = 12;
  ...
  return function removeTour(_x12) {
...
var stripe = Stripe('pk_test_51L0hsOJn1lF4rQdkbmVNawG4sDLzGJhIdxuLrzm3qfYovSuaUaZxIpvr4mR6mqZW1WGzuERb680RVROtrEmlzO0000EvdRSjeq');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2 create the form for checkout + process the paymant
...
// DOM ELEMENTS
var mapBox = document.getElementById('map'); //  SIGNUP

var selectForm = document.querySelector('.signUpform'); // LOGIN

var loginForm = document.querySelector('.login-form-get'); // LOG OUT BUTTON! 

var logOutBtn = document.querySelector('.logout--logout'); // UPDATE USER DATA 

var userData = document.querySelector('.admin-form'); // Update PASS

var userPasswordForm = document.querySelector('.form-user-settings'); // USER Photo rendering after upload

var userImgInputEl = document.getElementById('photo');
var userImgEl = document.querySelector('.form__user-photo'); // BOOKING TOUR

var bookButton = document.getElementById('book-tour');
console.log(bookButton); // REMOVE TOUR remove-tour

var removeTourFromadmin = document.querySelector('.for-select-this-shit'); // CREATE A NEW TOUR

var createTour = document.querySelector('.input-container-add-tour'); // DELAGATION
...
if (userData) userData.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (userImgInputEl) userImgInputEl.addEventListener('change', handleDisplayUserPhoto); //HANDELING BOOKING
